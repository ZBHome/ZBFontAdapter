...
#import "UIButton+ZBAdapter.h"
#import "ZBKit_DefineCommon.h"

@implementation UIButton (ZBAdapter)
...
- (void)zb_adapter
{
	...
	if (self.tag != 999)
	{
		self.titleLabel.font = [UIFont fontWithName:self.titleLabel.font.fontName size:self.titleLabel.font.pointSize * ZBKit_Scale];
	}
}
